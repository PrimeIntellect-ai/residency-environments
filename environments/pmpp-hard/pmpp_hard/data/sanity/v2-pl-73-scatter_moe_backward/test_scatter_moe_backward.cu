...
// ---- Sanity seed salt: shifts all generated INPUTS (weights + x/dy/up) so this
//      held-out grader's inputs differ from the real test; golden is regenerated. ----
static const uint64_t SANITY_SALT = 0xa5a5a5a5a5a5a5a5ull;

// ---- Splitmix64: deterministic input generation ----
struct SM64 {
    uint64_t s;
    SM64(uint64_t seed = 0xdeadbeefcafebabe) : s(seed ^ SANITY_SALT) {}
    uint64_t next() {
                      ...
                      int32_t pad_idx = -1, uint64_t wseed = 0x12345678abcdef01ull)
{
    ...
    s.flags       = 0;
    s.weight_seed = wseed ^ SANITY_SALT;  // sanity salt: shifts reference-generated weights
    s.reserved0   = 0;
    s.reserved1   = 0;
    return s;
}
...
int main() {
    ...
    static const GoldenCase kGolden[] = {
        { "basic_unique",          0xee6a9f3f3f0c58d5ull },
        { "dup_embed",             0xdddfa37a2708d1a2ull },
        { "hot_expert",            0x55d9c228708b96a1ull },
        { "dup_expert_token",      0xe502ba1e9fac6ed2ull },
        { "invalid_experts",       0x530d1a6112b26936ull },
        { "padding_invalid_index", 0x58dd9e2ec848954aull },
        { "ragged_dims",           0x490a436877f766a2ull },
        { "bf16_dtype",            0xceb93d3baa4dc2a3ull },
        { "zero_tokens",           0x45b0978160549d08ull },
        { "state_persist",         0x6d56c12f550f0222ull },
        { "reset_seq",             0xb4c556db520873a7ull },
        { "nan_inf_f32",           0x2bf9d3f3c68c03b3ull },
        { "nan_inf_bf16",          0xba8f146977d256cfull },
        { "clear_only",            0x4149eda014667e85ull },
        { "padding_idx_0",         0x1fce468d73852916ull },
    };
    static const uint64_t kGoldenFinal = 0x4f33e9898408ae37ull;
