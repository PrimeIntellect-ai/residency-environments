...
static uint64_t run_family_a() {
    ...
    spec.global_seed     = 0x1234567890ABCDEFull;
...
static uint64_t run_family_b() {
    ...
    spec.global_seed     = 0xFEDCBA9876543210ull;
...
static uint64_t run_family_c() {
    ...
    spec.num_ranks       = 4;
    spec.max_ops_per_run = 64;
    spec.global_seed     = 0xCAFEBABEDEADBEEFull;
...
static uint64_t run_family_d() {
    ...
    spec.num_ranks       = 2;
    spec.max_ops_per_run = 32;
    spec.global_seed     = 0xDEADDEADDEADDEADull;
...
static uint64_t run_family_e() {
    ...
    spec.num_ranks       = 7;
    spec.max_ops_per_run = 64;
    spec.global_seed     = 0xE1E2E3E4E5E6E7E8ull;
...
static uint64_t run_family_f() {
    ...
    spec.num_ranks       = 2;
    spec.max_ops_per_run = 32;
    spec.global_seed     = 0xF0F1F2F3F4F5F6F7ull;
...
static const GoldenFamily GOLDEN[6] = {
    { "FAMILY_A", 0x0b1a201d711088c1ull },
    { "FAMILY_B", 0x0c8731a6cdee8bd8ull },
    { "FAMILY_C", 0x0d4161fbaa32bcefull },
    { "FAMILY_D", 0x1af38a14a472211bull },
    { "FAMILY_E", 0xe457c1df4580d4ccull },
    { "FAMILY_F", 0xbb9c982ff476c15cull },
};
