...
// AGGREGATE HASH golden: 0x1f1c83d89c3be027  (informational)
// ---------------------------------------------------------------------------
struct GoldenRun {
    uint64_t tensor;
    uint64_t timeline;
...
static const GoldenRun g_gold[] = {
    ...
    // case_bf16_sum  (1 run)
    { 0x2b9eb8dd999995afULL, 0xb943c858d733d6afULL, 0xda0237c2432f963bULL, 0x6aacbeefd4617bc2ULL, 0x5471bcaebd9f756eULL },
    // case_seg_dup_keys  (1 run)
    { 0x04ff960df84822c3ULL, 0xf8df1f67432c7a8cULL, 0x4b32dc52a03d283eULL, 0xc65577b62bf8d017ULL, 0x1f2b87b7e2aea64bULL },
    // case_norm_subnormals  (1 run)
    { 0xe259ca0d3b2a4e2bULL, 0xbe0f8f702f10b2d4ULL, 0xa0255d5fba11674dULL, 0xf249dce25c766469ULL, 0xf8498c33b183fbebULL },
    // case_multirun_sum  (3 runs)
    { 0xeeeec0c4c5bbf057ULL, 0x5bfc940fc65e098fULL, 0xe46a0dec035ed387ULL, 0x5cbb66607385e6e9ULL, 0x9316c15a8986e116ULL },
    { 0xeeeec0c4c5bbf057ULL, 0x9f45179d5addf8faULL, 0x19c3b30d6d8a5f14ULL, 0xb9ffd1406e3496bfULL, 0x20f6c1020a204922ULL },
    { 0xeeeec0c4c5bbf057ULL, 0x4eeac6b52c2e5151ULL, 0x8bc8d4dfbe24357bULL, 0xa4559e5a4a7e0449ULL, 0xe6ebbf3741cf2890ULL },
    // case_mode_mismatch  (2 runs)
    { 0x41f8caa61dcf5fbfULL, 0x462093481437c4a4ULL, 0xcdbf7e06739392f5ULL, 0xdb81a64e059f3905ULL, 0x1d7e86ae0beae054ULL },
